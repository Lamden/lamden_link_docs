...
Transferring native Lamden tokens (ex. TAU) from either Ethereum (ERC20) or Binance Smart Chain (BEP20) to Lamden is a 5️⃣ step process. Before starting, you will require:
